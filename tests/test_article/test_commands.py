...
def test_create_article():
    """
    GIVEN CreateArticleCommand with a valid author, title and content
    WHEN the execute method is called
    THEN a new Article must exist in the database with the same attrs
    """
...
def test_create_article_already_exists():
    ...
    Article(
        author='jane@does.com',
        title='New Article',
        content='Super awesome mega content'
    ).save()
